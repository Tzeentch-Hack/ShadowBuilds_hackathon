        ...
        providers = new []
        {
            ...
            new OnlineMapsProvider("yandex", "Yandex Maps")
            {
                ...
                _types = new []
                {
                    ...
                    {
                        hasLanguage = true,
                        urlWithLabels = "https://core-renderer-tiles.maps.yandex.net/tiles?l=map&x={x}&y={y}&z={zoom}&scale=1&lang={lng}"
                    }, 
                    new MapType(SATELLITE)
                    {
                        urlWithoutLabels = "https://core-renderer-tiles.maps.yandex.net/tiles?l=sat&x={x}&y={y}&z={zoom}&scale=1&lang={lng}"
                    }, 
                }
            }, 
